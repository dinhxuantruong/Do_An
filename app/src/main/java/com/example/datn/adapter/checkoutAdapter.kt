...
class checkoutAdapter(
    private val activity: Activity,private val listProduct: MutableList<ItemCartsWithTotal>
) : RecyclerView.Adapter<checkoutAdapter.ckViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ckViewHolder, position: Int) {
        ...
        productName.text = ckItem.product.product_type_name
